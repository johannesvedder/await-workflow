...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield sleep(inputs.initialWaitSeconds);
        while (elapsedTimeSeconds < inputs.timeoutSeconds) {
            ...
            const latestWorkflowRun = (_a = response.data.workflow_runs) === null || _a === void 0 ? void 0 : _a[0];
            const totalCounts = response.data.total_count;
            if (totalCounts === 0) {
                core.debug('No runs of the given workflow found');
                break;
            }
            const latestRunStatus = latestWorkflowRun === null || latestWorkflowRun === void 0 ? void 0 : latestWorkflowRun.status;
            const latestRunConclusion = latestWorkflowRun === null || latestWorkflowRun === void 0 ? void 0 : latestWorkflowRun.conclusion;
            ...
            if (elapsedTimeSeconds < inputs.timeoutSeconds) {
                ...
                yield sleep(inputs.retryIntervalSeconds);
            }
            else {
